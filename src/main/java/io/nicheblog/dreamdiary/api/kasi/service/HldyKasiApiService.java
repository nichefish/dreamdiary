...
import io.nicheblog.dreamdiary.cmm.util.DateParser;
...
import net.sinzi.intranet.web.repository.schdul.SchdulRepository;
import net.sinzi.intranet.web.service.schdul.SchdulService;
...
/**
    ...
    public List<HldyKasiApiItemDto> getHldyList(final String yyParam) throws Exception {
        ...
        final String serviceKey = "nEV3ii2%2B%2BQx%2FlOcC4W9PFXRDzAEeaL9saxCefl7bLKs6i1DIa9B1joBwZZfSj8V5whJnvwYyWMc7l7hL%2F9bqQA%3D%3D";
        int numOfRows = 30;
        try {
...
/**
    ...
    public void delHldyList(final String yyStr) throws Exception {
        Map<String, Object> searchParamMap = new HashMap() {{
            put("searchStartDt", DateUtil.asDate(yyStr + "-01-01"));
            put("searchEndDt", DateParser.eDateParse(DateUtil.asDate(yyStr + "-12-31")));
            put("boardCd", "hldyApi");
        }};
