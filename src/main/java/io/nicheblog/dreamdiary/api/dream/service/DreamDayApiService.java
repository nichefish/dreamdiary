...
public class DreamDayApiService
        implements BaseMultiCrudService<DreamDayApiDto, DreamDayApiDto, Integer, DreamDayEntity, DreamDayRepository, DreamDaySpec, DreamDayApiMapstruct, CmmFileService> {
