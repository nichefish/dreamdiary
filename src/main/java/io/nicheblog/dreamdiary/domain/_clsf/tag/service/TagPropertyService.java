...
import io.nicheblog.dreamdiary.domain._clsf.tag.entity.TagPropertyEntity;
import io.nicheblog.dreamdiary.domain._clsf.tag.mapstruct.TagPropertyMapstruct;
import io.nicheblog.dreamdiary.domain._clsf.tag.model.TagPropertyDto;
import io.nicheblog.dreamdiary.domain._clsf.tag.repository.jpa.TagPropertyRepository;
import io.nicheblog.dreamdiary.domain._clsf.tag.spec.TagPropertySpec;
