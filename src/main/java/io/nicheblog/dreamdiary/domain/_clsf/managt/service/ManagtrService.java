package io.nicheblog.dreamdiary.domain._clsf.managt.service;

import io.nicheblog.dreamdiary.domain._clsf.managt.entity.ManagtrEntity;
import io.nicheblog.dreamdiary.domain._clsf.managt.repository.jpa.ManagtrRepository;
import io.nicheblog.dreamdiary.domain._core.auth.util.AuthUtils;
import io.nicheblog.dreamdiary.domain._clsf.managt.spec.ManagtrSpec;
