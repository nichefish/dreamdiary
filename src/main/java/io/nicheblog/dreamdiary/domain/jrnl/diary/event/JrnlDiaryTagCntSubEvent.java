 ...
 */
@Getter
public class JrnlDiaryTagCntSubEvent
     ...
     */
    public JrnlDiaryTagCntSubEvent(final Object source, final Integer yy, final Integer mnth, final List<Integer> tagNoList) {
        super(source);
