 ...
 */
@Getter
public class JrnlDreamTagCntSubEvent
     ...
     */
    public JrnlDreamTagCntSubEvent(final Object source, final Integer yy, final Integer mnth, final List<Integer> tagNoList) {
        super(source);
