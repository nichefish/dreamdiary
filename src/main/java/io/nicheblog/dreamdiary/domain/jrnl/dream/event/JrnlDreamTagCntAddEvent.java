package io.nicheblog.dreamdiary.domain.jrnl.dream.event;
 ...
 */
@Getter
public class JrnlDreamTagCntAddEvent
     ...
     */
    public JrnlDreamTagCntAddEvent(final Object source, final Integer yy, final Integer mnth, final List<Integer> tagNoList) {
        super(source);
