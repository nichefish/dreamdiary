package io.nicheblog.dreamdiary.domain.exptr.reqst.spec;
 ...
 * ExptrReqstSpec
 * <pre>
 *  물품구매/경조사비 신청 목록 검색인자 세팅 Specification.
 * </pre>
 *
 * @author nichefish
 */
...
public class ExptrReqstSpec
        implements BasePostSpec<ExptrReqstEntity> {
    ...
    public List<Predicate> getPredicateWithParams(
            ...
            final Root<ExptrReqstEntity> root,
