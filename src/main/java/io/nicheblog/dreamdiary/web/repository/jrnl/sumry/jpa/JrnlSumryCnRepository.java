package io.nicheblog.dreamdiary.web.repository.jrnl.sumry.jpa;
...
public interface JrnlSumryCnRepository
    ...
    @Override
    @EntityGraph(value = "JrnlSumryCnEntity.withAll")
    Optional<JrnlSumryCnEntity> findById(Integer key);
    ...
    @Query("SELECT MAX(cn.idx) " +
            ...
            "INNER JOIN FETCH JrnlSumryEntity sumry ON cn.jrnlSumryNo = sumry.postNo " +
            "WHERE sumry.postNo = :jrnlSumryNo AND cn.ctgrCd = :jrnlSumryTyCd")
