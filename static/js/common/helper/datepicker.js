...
cF.datepicker = (function () {
     ...
     * 시간 포함 날짜 옵션
     */
    const timeOptions = Object.assign(Object.assign({}, baseOptions), { timePicker: true, timePicker24Hour: true, timePickerSeconds: true, locale: Object.assign(Object.assign({}, baseOptions.locale), { format: cF.date.ptnDatetime }) });
    return {
        /**
        ...
        singleDatePicker: function (selector, format, initDt, func, additionalOptions = {}) {
            ...
            // 날짜 형식 설정
            if (cF.util.isNotEmpty(format))
                mergedOptions.locale.format = format;
            // 초기 날짜 설정 ('today'가 아닌 경우에만 설정)
            if (initDt !== 'today')
                mergedOptions.startDate = cF.util.isEmpty(initDt) ? undefined : initDt;
            // datepicker 초기화
