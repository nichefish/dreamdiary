...
cF.util = (function() {
    return {
         ...
         */
        swalOrAlert: function(msg, func: Function) {
         ...
         */
        ajax: function(option, func: Function, continueBlock: string) {
            cF.util.blockUI();
            $.ajax(
                option
            ).done(function(res) {
         ...
         */
        blockUIAjax: function(url: string, method: string, ajaxData: object, func: Function, continueBlock: string) {
            const option = {
                url: url,
         ...
         * @param {boolean} [continueBlock] - 추가적인 블록 UI 동작 여부 (선택적).
         */
        blockUIMultipartAjax: function(url: string, ajaxData, func: Function, continueBlock: string) {
            const option = {
                url: url,
                type: 'POST',
                data: ajaxData,
         ...
         * @param {boolean} [continueBlock] - 추가적인 블록 UI 동작 여부 (선택적).
         */
        blockUIAsyncAjax: function(url: string, method: string, ajaxData, func: Function, continueBlock: string) {
            const option = {
                url: url,
                type: method.toUpperCase(),
                data: ajaxData,
         ...
         * @param {boolean} [continueBlock] - 추가적인 블록 UI 동작 여부 (선택적).
         */
        blockUIJsonAjax: function(url: string, method: string, ajaxData, func: Function, continueBlock: string) {
            const option = {
                url: url,
                type: method.toUpperCase(),
                data: ajaxData,
