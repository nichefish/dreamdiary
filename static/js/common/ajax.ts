...
cF.ajax = (function() {
    return {
         ...
         */
        request: function(option: object, func: Function, continueBlock: string) {
            cF.util.blockUI();
            $.ajax(
                option
            ).done(function(res) {
            ...
            }).fail(function(res: AjaxResponse) {
         ...
         * @param {boolean} [continueBlock] - 추가적인 블록 UI 동작 여부 (선택적).
         */
        post: function(url: string, ajaxData: object, func: Function, continueBlock: string) {
            const option = {
                url: url,
                type: 'POST',
                data: ajaxData,
         ...
         * @param {boolean} [continueBlock] - 추가적인 블록 UI 동작 여부 (선택적).
         */
        multipartRequest: function(url: string, ajaxData: object, func: Function, continueBlock: string) {
            const option = {
                url: url,
                type: 'POST',
                data: ajaxData,
         ...
         * @param {boolean} [continueBlock] - 추가적인 블록 UI 동작 여부 (선택적).
         */
        asyncRequest: function(url: string, method: string, ajaxData: object, func: Function, continueBlock: string) {
            const option = {
                url: url,
         ...
         * @param {boolean} [continueBlock] - 추가적인 블록 UI 동작 여부 (선택적).
         */
        jsonRequest: function(url: string, method: string, ajaxData: object, func: Function, continueBlock: string) {
            const option = {
                url: url,
                type: method.toUpperCase(),
                data: ajaxData,
