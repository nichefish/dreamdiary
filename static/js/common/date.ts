...
cF.date = (function() {
    return {
         ...
         */
        strToDate: function(dateStr: string) {
         ...
         */
        dateToStr: function(date: Date, pattern: string) {
         ...
         * @returns {string|undefined} - 변환된 날짜 문자열 또는 유효하지 않은 경우 `undefined`.
         */
        asStr: function(date: Date|string, pattern: string) {
            pattern = pattern || cF.date.ptnDate;      // 패턴이 없을 경우 기본 패턴 설정
         ...
         */
        normalizeDateStr: function(dateStr: string, delim = "-") {
            if (dateStr.length === 8) {
         ...
         */
        getCurrDateStr: function(pattern: string) {
            pattern = pattern || cF.date.ptnDate;      // 패턴이 없을 경우 기본 패턴 설정
         ...
         * @returns {string} - 변환된 날짜 문자열.
         */
        getPrevDateStr: function(pattern: string) {
            pattern = pattern || cF.date.ptnDate;      // 패턴이 없을 경우 기본 패턴 설정
         ...
         */
        getNextDateStr: function(pattern: string) {
            pattern = pattern || cF.date.ptnDate;      // 패턴이 없을 경우 기본 패턴 설정
         ...
         */
        getCurrDateAddDay: function(day: number) {
         ...
         */
        getCurrDateAddDayStr: function(day: number, pattern: string) {
            pattern = pattern || cF.date.ptnDate;      // 패턴이 없을 경우 기본 패턴 설정
         ...
         */
        getDateAddDay: function(paramDate: Date|string, day: number) {
            // 유효한 날짜인지 확인
         ...
         */
        getEndOfDay: function(paramDate: Date|string) {
            // 유효한 날짜인지 확인
         ...
         */
        getDateAddDayStr: function(date: Date|string, day: number, pattern: string) {
         ...
         * @returns {Date|null} - 일수가 더해진 새로운 `Date` 객체 또는 유효하지 않은 경우 `null`.
         */
        getDateStrAddDay: function(datestr: string, day: number) {
            // 유효한 날짜인지 확인
         ...
         * @returns {string|null} - 일수가 더해진 날짜를 지정된 패턴으로 변환한 문자열 또는 유효하지 않은 경우 `null`.
         */
        getDateStrAddDayStr: function(datestr: string, day: number, pattern: string) {
            // 유효한 날짜인지 확인
         ...
         */
        getCurrDatetimeStr: function(pattern: string) {
            pattern = pattern || cF.date.ptnDate;      // 패턴이 없을 경우 기본 패턴 설정
         ...
         */
        getDateStrStr: function(dateStr: string, pattern: string) {
            // 날짜 형식이 8자리인 경우 `YYYY-MM-DD`로 변환
         ...
         */
        getDatetimeStr: function(date: Date, pattern: string) {
            if (!(date instanceof Date)) return;
         ...
         */
        getCurrDateWithinChk: function(startDt: Date|string, endDt: Date|string) {
            // 현재 날짜를 문자열 형식으로 가져옴
         ...
         */
        getDateWithinChk: function(dt: Date|string, startDt: Date|string, endDt: Date|string) {
            // 입력 값들을 Date 객체로 변환
         ...
         */
        getDayweekStr: function(date: Date|string, locale: string) {
            // 날짜를 `Date` 객체로 변환
         ...
         */
        getWeekdayDate: function(date: Date|string, paramWeekday: number) {
            // 입력된 날짜를 `Date` 객체로 변환
            const asDate = cF.date.asDate(date);
         ...
         */
        getWeekdayDateStr: function(date: Date|string, paramWeekday: number, pattern: string) {
            pattern = pattern || cF.date.ptnDate;      // 패턴이 없을 경우 기본 패턴 설정
         ...
         */
        isBefore: function(beginSelector: string, endSelector: string) {
            // 시작일과 종료일의 값 가져오기
         ...
         */
        navigateDate: function(searchType: string, stdrdDate: Date|string, type: string) {
            // 기준일을 Date 객체로 변환
         ...
         * @returns {Date|null} - 이동한 날짜를 나타내는 `Date` 객체 또는 유효하지 않은 경우 `null`.
         */
        navigateDateStr: function(searchType: string, stdrdDate: Date|string, type: string, pattern: string) {
